...
describe("getPromotionItems",function(){
  it("getPromotionItems", function(){
    ...
    expect(result).toEqual(cartItemsCountTypePromotion)
  })
...
describe("getSubTotal", function() {
  it("getSubTotal",function(){
    ...
    let result= getSubTotal(cartItemsCountTypePromotion);
    let subTotalItems = [
      {
        id: 'ITEM0001',
        name: '黄焖鸡',
...
describe("getSaveMoney",function(){
  it("getSaveMoney", function(){
    ...
    let result = getSaveMoney(cartItemsCountTypePromotion);
    let saveMoney = 13.00;
...
describe("getTotal", function(){
  it("getTotal",function(){
    ...
    let result = getTotal(cartItemsCountTypePromotion);
    let total = 25.00;
